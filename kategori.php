              ...
              <div class="col-lg-4 col-sm-6">
                <div class="product text-center">
                  <div class="mb-3 position-relative">
                    ...
                    <a class="d-block" href="detail_produk.php?id_produk=<?php echo $data['id_produk'] ?>">
                      <img class="img-fluid w-100" src="<?php echo 'admin/upload/produk/' . $data['foto'] ?>" alt="Foto Produk">
                    </a>
