 ...
 <section class="py-5">
        <div class="container">
          <div class="row mb-5">
            ...
            <div class="col-lg-6">
              ...
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-4 pl-sm-0"><input class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" type="submit" value="Masukkan Keranjang"></div>
              </div><br>
          ...
          <div class="row">
            <!-- PRODUCT-->
             <?php   
                  $sql = "SELECT * FROM kategori INNER JOIN produk ON kategori.id_kategori = produk.id_kategori order by id_produk DESC";
                  $query = mysqli_query($koneksi, $sql);
                  while ($data = mysqli_fetch_array($query)) { ?>
            <div class="col-lg-3 col-sm-6">
              <div class="product text-center skel-loader">
                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail_produk.php?id_produk=<?php echo $data['id_produk'] ?>"><img class="img-fluid w-100" src="<?php echo '../admin/upload/produk/'.$data['foto'] ?>" alt="..."></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
                      
                      <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="produk.php">Lihat Produk</a></li>
                      
                    </ul>
                  </div>
                </div>
                <h6> <a class="reset-anchor" href="detail.html"><?php echo $data['nama_produk'] ?></a></h6>
