            ...
            <div class="row">
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                  <!-- PRODUCT-->
                  <?php   
                    $query = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_kategori='$id' order by id_produk ASC");
                      ...
                      <div class="mb-3 position-relative">
                        ...
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            ...
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="detail_produk.php?id_produk=<?php echo $data['id_produk'] ?>">Detail Produk</a></li>
